# divide and conquer 
# divide array in to the smallest sub array possible (length one)
# merge each individual sub array by sorting the Left and Right sub array in ascending order
# a copy is created for each Left and Right array based on the original input array 
# Efficiency : 
# Time efficiency : nlogn 
# Space efficiency : n
